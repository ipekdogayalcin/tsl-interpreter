"""
Constants and configuration for the Turkish Sign Language Interpreter.

This module contains constants, class mappings, and configuration parameters
used throughout the TSL Interpreter application.
"""
...
# Class mapping for Turkish Sign Language signs
CLASS_MAPPING = {
    0: "abla (sister)",  
    1: "acele (hurry)",  
    2: "acikmak (hungry)",  
